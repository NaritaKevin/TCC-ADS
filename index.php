...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <!---Notificação e settings do perfil-->
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-6 grid-margin transparent">
              <div class="row">
                <div id="cardAtividade" class="col-md-6 mb-4 stretch-card transparent" style="cursor: pointer;">
                    ...
                    <div class="card-body">
                      ...
                      <?php  }else{ ?>
                        ...
                        <div class="col-md-2 d-flex justify-content-center" >
                          <i class="bi bi-plus-lg align-self-center" ></i>
                        </div>
                      </div>
                    </div>  
                  </div>
                </div>
                <div id="cardQuestao" class="col-md-6 mb-4 stretch-card transparent" style="cursor: pointer;">
              ...
              <div class="row">
                <div id="cardDisciplina" class="col-md-6 mb-4 mb-lg-0 stretch-card transparent" style="cursor: pointer;">
                ...
                <div id="cardResultado" class="col-md-6 stretch-card transparent" style="cursor: pointer;">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <?php  }else{ ?>
                        ...
                        <div class="col-md-2 d-flex justify-content-center" >
                          <i class="bi bi-bar-chart-line align-self-center" style="font-size: 1.7rem" ></i>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <script src="js/mainjs/index.js"></script>
